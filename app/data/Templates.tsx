export default  [
...

    {
        ...
        desc: "Struggling to write high-converting ad copy? Our AI tool generates compelling headlines, descriptions, and CTAs that drive clicks and conversions.",
        icon:'https://cdn-icons-png.flaticon.com/128/12417/12417933.png',
        category: 'Marketting',
       
        slug: 'AdCopy-generator',
        aiPrompt: 'Based on user-provided productName, outline, and targetAudience, generate 3–5 variations of ad copy including headline, short description, and clear call-to-action (CTA). Format the output for a rich text editor with bold section titles and line breaks for readability.',
        ...
        form: [
            ...
            {
                label: 'Whom you are selling / Marketting to?',
                field: 'textarea',
                name: 'targetAudience',
                required:true
            },
